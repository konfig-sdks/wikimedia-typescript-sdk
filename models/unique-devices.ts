...
import { UniqueDevicesItemsInner } from './unique-devices-items-inner';

/**
 * 
 * @export
 * @interface UniqueDevices
 */
export interface UniqueDevices {
    /**
     * 
     * @type {Array<UniqueDevicesItemsInner>}
     * @memberof UniqueDevices
     */
    'items'?: Array<UniqueDevicesItemsInner>;
}
