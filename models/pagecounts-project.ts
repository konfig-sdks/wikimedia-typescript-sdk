...
import { PagecountsProjectItemsInner } from './pagecounts-project-items-inner';

/**
 * 
 * @export
 * @interface PagecountsProject
 */
export interface PagecountsProject {
    /**
     * 
     * @type {Array<PagecountsProjectItemsInner>}
     * @memberof PagecountsProject
     */
    'items'?: Array<PagecountsProjectItemsInner>;
}
