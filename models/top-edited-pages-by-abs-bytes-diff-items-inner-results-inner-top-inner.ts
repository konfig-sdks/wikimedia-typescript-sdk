 ...
 * 
 * @export
 * @interface TopEditedPagesByAbsBytesDiffItemsInnerResultsInnerTopInner
 */
export interface TopEditedPagesByAbsBytesDiffItemsInnerResultsInnerTopInner {
    /**
     * 
     * @type {number}
     * @memberof TopEditedPagesByAbsBytesDiffItemsInnerResultsInnerTopInner
     */
    'abs_bytes_diff'?: number;
    /**
     * 
     * @type {string}
     * @memberof TopEditedPagesByAbsBytesDiffItemsInnerResultsInnerTopInner
