...
import { TopEditorsByAbsBytesDiffItemsInnerResultsInner } from './top-editors-by-abs-bytes-diff-items-inner-results-inner';

/**
 * 
 * @export
 * @interface TopEditorsByAbsBytesDiffItemsInner
 */
export interface TopEditorsByAbsBytesDiffItemsInner {
    /**
     * 
     * @type {string}
     * @memberof TopEditorsByAbsBytesDiffItemsInner
     */
    'editor-type'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TopEditorsByAbsBytesDiffItemsInnerResultsInner>}
     * @memberof TopEditorsByAbsBytesDiffItemsInner
     */
    'results'?: Array<TopEditorsByAbsBytesDiffItemsInnerResultsInner>;
}
