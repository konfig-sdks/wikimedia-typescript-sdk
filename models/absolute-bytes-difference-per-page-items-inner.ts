 ...
 * 
 * @export
 * @interface AbsoluteBytesDifferencePerPageItemsInner
 */
export interface AbsoluteBytesDifferencePerPageItemsInner {
    /**
     * 
     * @type {string}
     * @memberof AbsoluteBytesDifferencePerPageItemsInner
     */
    'editor-type'?: string;
    /**
     * 
