...
import { AbsoluteBytesDifferencePerEditorItemsInner } from './absolute-bytes-difference-per-editor-items-inner';

/**
 * 
 * @export
 * @interface AbsoluteBytesDifferencePerEditor
 */
export interface AbsoluteBytesDifferencePerEditor {
    /**
     * 
     * @type {Array<AbsoluteBytesDifferencePerEditorItemsInner>}
     * @memberof AbsoluteBytesDifferencePerEditor
     */
    'items'?: Array<AbsoluteBytesDifferencePerEditorItemsInner>;
}
