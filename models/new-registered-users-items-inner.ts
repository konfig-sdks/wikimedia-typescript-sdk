...
import { NewRegisteredUsersItemsInnerResultsInner } from './new-registered-users-items-inner-results-inner';

/**
 * 
 * @export
 * @interface NewRegisteredUsersItemsInner
 */
export interface NewRegisteredUsersItemsInner {
    /**
     * 
     * @type {string}
     * @memberof NewRegisteredUsersItemsInner
     */
    'granularity'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<NewRegisteredUsersItemsInnerResultsInner>}
     * @memberof NewRegisteredUsersItemsInner
     */
    'results'?: Array<NewRegisteredUsersItemsInnerResultsInner>;
}
