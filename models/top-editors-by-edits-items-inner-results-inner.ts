...
import { TopEditorsByEditsItemsInnerResultsInnerTopInner } from './top-editors-by-edits-items-inner-results-inner-top-inner';

/**
 * 
 * @export
 * @interface TopEditorsByEditsItemsInnerResultsInner
 */
export interface TopEditorsByEditsItemsInnerResultsInner {
    /**
     * 
     * @type {string}
     * @memberof TopEditorsByEditsItemsInnerResultsInner
     */
    'timestamp'?: string;
    /**
     * 
     * @type {Array<TopEditorsByEditsItemsInnerResultsInnerTopInner>}
     * @memberof TopEditorsByEditsItemsInnerResultsInner
     */
    'top'?: Array<TopEditorsByEditsItemsInnerResultsInnerTopInner>;
}
