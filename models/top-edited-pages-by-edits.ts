...
import { TopEditedPagesByEditsItemsInner } from './top-edited-pages-by-edits-items-inner';

/**
 * 
 * @export
 * @interface TopEditedPagesByEdits
 */
export interface TopEditedPagesByEdits {
    /**
     * 
     * @type {Array<TopEditedPagesByEditsItemsInner>}
     * @memberof TopEditedPagesByEdits
     */
    'items'?: Array<TopEditedPagesByEditsItemsInner>;
}
