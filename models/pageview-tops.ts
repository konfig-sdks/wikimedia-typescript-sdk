...
import { PageviewTopsItemsInner } from './pageview-tops-items-inner';

/**
 * 
 * @export
 * @interface PageviewTops
 */
export interface PageviewTops {
    /**
     * 
     * @type {Array<PageviewTopsItemsInner>}
     * @memberof PageviewTops
     */
    'items'?: Array<PageviewTopsItemsInner>;
}
