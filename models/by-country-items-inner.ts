...
import { ByCountryItemsInnerCountriesInner } from './by-country-items-inner-countries-inner';

/**
 * 
 * @export
 * @interface ByCountryItemsInner
 */
export interface ByCountryItemsInner {
    /**
     * 
     * @type {string}
     * @memberof ByCountryItemsInner
     */
    'access'?: string;
    /**
     * 
     * @type {Array<ByCountryItemsInnerCountriesInner>}
     * @memberof ByCountryItemsInner
     */
    'countries'?: Array<ByCountryItemsInnerCountriesInner>;
    /**
     * 
     * @type {string}
     * @memberof ByCountryItemsInner
