...
import { AbsoluteBytesDifferenceItemsInnerResultsInner } from './absolute-bytes-difference-items-inner-results-inner';

/**
 * 
 * @export
 * @interface AbsoluteBytesDifferencePerEditorItemsInner
 */
export interface AbsoluteBytesDifferencePerEditorItemsInner {
    /**
     * 
     * @type {string}
     * @memberof AbsoluteBytesDifferencePerEditorItemsInner
     */
    'granularity'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<AbsoluteBytesDifferenceItemsInnerResultsInner>}
     * @memberof AbsoluteBytesDifferencePerEditorItemsInner
     */
    'results'?: Array<AbsoluteBytesDifferenceItemsInnerResultsInner>;
    /**
     * 
     * @type {string}
     * @memberof AbsoluteBytesDifferencePerEditorItemsInner
