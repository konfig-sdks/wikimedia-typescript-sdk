...
import { AbsoluteBytesDifferencePerPageItemsInner } from './absolute-bytes-difference-per-page-items-inner';

/**
 * 
 * @export
 * @interface AbsoluteBytesDifferencePerPage
 */
export interface AbsoluteBytesDifferencePerPage {
    /**
     * 
     * @type {Array<AbsoluteBytesDifferencePerPageItemsInner>}
     * @memberof AbsoluteBytesDifferencePerPage
     */
    'items'?: Array<AbsoluteBytesDifferencePerPageItemsInner>;
}
