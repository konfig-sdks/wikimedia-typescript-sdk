...
import { TopEditorsByEditsItemsInner } from './top-editors-by-edits-items-inner';

/**
 * 
 * @export
 * @interface TopEditorsByEdits
 */
export interface TopEditorsByEdits {
    /**
     * 
     * @type {Array<TopEditorsByEditsItemsInner>}
     * @memberof TopEditorsByEdits
     */
    'items'?: Array<TopEditorsByEditsItemsInner>;
}
