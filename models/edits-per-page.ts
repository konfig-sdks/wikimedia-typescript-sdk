...
import { EditsPerPageItemsInner } from './edits-per-page-items-inner';

/**
 * 
 * @export
 * @interface EditsPerPage
 */
export interface EditsPerPage {
    /**
     * 
     * @type {Array<EditsPerPageItemsInner>}
     * @memberof EditsPerPage
     */
    'items'?: Array<EditsPerPageItemsInner>;
}
