 ...
 * 
 * @export
 * @interface AbsoluteBytesDifferenceItemsInnerResultsInner
 */
export interface AbsoluteBytesDifferenceItemsInnerResultsInner {
    /**
     * 
     * @type {number}
     * @memberof AbsoluteBytesDifferenceItemsInnerResultsInner
     */
