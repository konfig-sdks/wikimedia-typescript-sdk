...
import { EditsItemsInnerResultsInner } from './edits-items-inner-results-inner';

/**
 * 
 * @export
 * @interface EditsPerEditorItemsInner
 */
export interface EditsPerEditorItemsInner {
    /**
     * 
     * @type {string}
     * @memberof EditsPerEditorItemsInner
     */
    'granularity'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<EditsItemsInnerResultsInner>}
     * @memberof EditsPerEditorItemsInner
     */
    'results'?: Array<EditsItemsInnerResultsInner>;
    /**
     * 
     * @type {string}
     * @memberof EditsPerEditorItemsInner
