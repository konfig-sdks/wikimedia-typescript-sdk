...
import { AbsoluteBytesDifferenceItemsInner } from './absolute-bytes-difference-items-inner';

/**
 * 
 * @export
 * @interface AbsoluteBytesDifference
 */
export interface AbsoluteBytesDifference {
    /**
     * 
     * @type {Array<AbsoluteBytesDifferenceItemsInner>}
     * @memberof AbsoluteBytesDifference
     */
    'items'?: Array<AbsoluteBytesDifferenceItemsInner>;
}
