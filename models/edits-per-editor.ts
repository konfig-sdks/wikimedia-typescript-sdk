...
import { EditsPerEditorItemsInner } from './edits-per-editor-items-inner';

/**
 * 
 * @export
 * @interface EditsPerEditor
 */
export interface EditsPerEditor {
    /**
     * 
     * @type {Array<EditsPerEditorItemsInner>}
     * @memberof EditsPerEditor
     */
    'items'?: Array<EditsPerEditorItemsInner>;
}
