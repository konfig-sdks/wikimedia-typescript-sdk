 ...
 * 
 * @export
 * @interface NewRegisteredUsersItemsInnerResultsInner
 */
export interface NewRegisteredUsersItemsInnerResultsInner {
    /**
     * 
     * @type {number}
     * @memberof NewRegisteredUsersItemsInnerResultsInner
     */
