 ...
 * 
 * @export
 * @interface TopEditorsByEditsItemsInnerResultsInnerTopInner
 */
export interface TopEditorsByEditsItemsInnerResultsInnerTopInner {
    /**
     * 
     * @type {number}
     * @memberof TopEditorsByEditsItemsInnerResultsInnerTopInner
     */
    'edits'?: number;
    /**
     * 
