...
import { NetBytesDifferenceItemsInner } from './net-bytes-difference-items-inner';

/**
 * 
 * @export
 * @interface NetBytesDifference
 */
export interface NetBytesDifference {
    /**
     * 
     * @type {Array<NetBytesDifferenceItemsInner>}
     * @memberof NetBytesDifference
     */
    'items'?: Array<NetBytesDifferenceItemsInner>;
}
