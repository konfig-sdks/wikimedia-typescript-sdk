...
import { NetBytesDifferencePerEditorItemsInner } from './net-bytes-difference-per-editor-items-inner';

/**
 * 
 * @export
 * @interface NetBytesDifferencePerEditor
 */
export interface NetBytesDifferencePerEditor {
    /**
     * 
     * @type {Array<NetBytesDifferencePerEditorItemsInner>}
     * @memberof NetBytesDifferencePerEditor
     */
    'items'?: Array<NetBytesDifferencePerEditorItemsInner>;
}
