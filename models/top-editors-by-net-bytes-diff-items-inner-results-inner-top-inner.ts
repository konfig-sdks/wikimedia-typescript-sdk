 ...
 * 
 * @export
 * @interface TopEditorsByNetBytesDiffItemsInnerResultsInnerTopInner
 */
export interface TopEditorsByNetBytesDiffItemsInnerResultsInnerTopInner {
    /**
     * 
     * @type {number}
     * @memberof TopEditorsByNetBytesDiffItemsInnerResultsInnerTopInner
     */
