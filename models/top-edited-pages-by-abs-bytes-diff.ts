...
import { TopEditedPagesByAbsBytesDiffItemsInner } from './top-edited-pages-by-abs-bytes-diff-items-inner';

/**
 * 
 * @export
 * @interface TopEditedPagesByAbsBytesDiff
 */
export interface TopEditedPagesByAbsBytesDiff {
    /**
     * 
     * @type {Array<TopEditedPagesByAbsBytesDiffItemsInner>}
     * @memberof TopEditedPagesByAbsBytesDiff
     */
    'items'?: Array<TopEditedPagesByAbsBytesDiffItemsInner>;
}
