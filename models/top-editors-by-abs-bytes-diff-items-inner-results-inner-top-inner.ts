 ...
 * 
 * @export
 * @interface TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner
 */
export interface TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner {
    /**
     * 
     * @type {number}
     * @memberof TopEditorsByAbsBytesDiffItemsInnerResultsInnerTopInner
     */
