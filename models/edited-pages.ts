...
import { EditedPagesItemsInner } from './edited-pages-items-inner';

/**
 * 
 * @export
 * @interface EditedPages
 */
export interface EditedPages {
    /**
     * 
     * @type {Array<EditedPagesItemsInner>}
     * @memberof EditedPages
     */
    'items'?: Array<EditedPagesItemsInner>;
}
