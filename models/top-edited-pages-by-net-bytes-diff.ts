...
import { TopEditedPagesByNetBytesDiffItemsInner } from './top-edited-pages-by-net-bytes-diff-items-inner';

/**
 * 
 * @export
 * @interface TopEditedPagesByNetBytesDiff
 */
export interface TopEditedPagesByNetBytesDiff {
    /**
     * 
     * @type {Array<TopEditedPagesByNetBytesDiffItemsInner>}
     * @memberof TopEditedPagesByNetBytesDiff
     */
    'items'?: Array<TopEditedPagesByNetBytesDiffItemsInner>;
}
