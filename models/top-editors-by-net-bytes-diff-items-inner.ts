...
import { TopEditorsByNetBytesDiffItemsInnerResultsInner } from './top-editors-by-net-bytes-diff-items-inner-results-inner';

/**
 * 
 * @export
 * @interface TopEditorsByNetBytesDiffItemsInner
 */
export interface TopEditorsByNetBytesDiffItemsInner {
    /**
     * 
     * @type {string}
     * @memberof TopEditorsByNetBytesDiffItemsInner
     */
    'editor-type'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TopEditorsByNetBytesDiffItemsInnerResultsInner>}
     * @memberof TopEditorsByNetBytesDiffItemsInner
     */
    'results'?: Array<TopEditorsByNetBytesDiffItemsInnerResultsInner>;
}
