...
import { NewRegisteredUsersItemsInner } from './new-registered-users-items-inner';

/**
 * 
 * @export
 * @interface NewRegisteredUsers
 */
export interface NewRegisteredUsers {
    /**
     * 
     * @type {Array<NewRegisteredUsersItemsInner>}
     * @memberof NewRegisteredUsers
     */
    'items'?: Array<NewRegisteredUsersItemsInner>;
}
