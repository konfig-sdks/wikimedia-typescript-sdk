...
import { TopEditorsByNetBytesDiffItemsInner } from './top-editors-by-net-bytes-diff-items-inner';

/**
 * 
 * @export
 * @interface TopEditorsByNetBytesDiff
 */
export interface TopEditorsByNetBytesDiff {
    /**
     * 
     * @type {Array<TopEditorsByNetBytesDiffItemsInner>}
     * @memberof TopEditorsByNetBytesDiff
     */
    'items'?: Array<TopEditorsByNetBytesDiffItemsInner>;
}
