...
import { TopEditorsByEditsItemsInnerResultsInner } from './top-editors-by-edits-items-inner-results-inner';

/**
 * 
 * @export
 * @interface TopEditorsByEditsItemsInner
 */
export interface TopEditorsByEditsItemsInner {
    /**
     * 
     * @type {string}
     * @memberof TopEditorsByEditsItemsInner
     */
    'editor-type'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TopEditorsByEditsItemsInnerResultsInner>}
     * @memberof TopEditorsByEditsItemsInner
     */
    'results'?: Array<TopEditorsByEditsItemsInnerResultsInner>;
}
