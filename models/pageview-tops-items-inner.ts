...
import { PageviewTopsItemsInnerArticlesInner } from './pageview-tops-items-inner-articles-inner';

/**
 * 
 * @export
 * @interface PageviewTopsItemsInner
 */
export interface PageviewTopsItemsInner {
    /**
     * 
     * @type {string}
     * @memberof PageviewTopsItemsInner
     */
    'access'?: string;
    /**
     * 
     * @type {Array<PageviewTopsItemsInnerArticlesInner>}
     * @memberof PageviewTopsItemsInner
     */
    'articles'?: Array<PageviewTopsItemsInnerArticlesInner>;
    /**
     * 
     * @type {string}
     * @memberof PageviewTopsItemsInner
