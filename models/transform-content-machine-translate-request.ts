 ...
 * 
 * @export
 * @interface TransformContentMachineTranslateRequest
 */
export interface TransformContentMachineTranslateRequest {
    /**
     * The HTML content to translate
     * @type {string}
     * @memberof TransformContentMachineTranslateRequest
     */
    'html': string;
}
