...
import { TopEditedPagesByEditsItemsInnerResultsInner } from './top-edited-pages-by-edits-items-inner-results-inner';

/**
 * 
 * @export
 * @interface TopEditedPagesByEditsItemsInner
 */
export interface TopEditedPagesByEditsItemsInner {
    /**
     * 
     * @type {string}
     * @memberof TopEditedPagesByEditsItemsInner
     */
    'editor-type'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TopEditedPagesByEditsItemsInnerResultsInner>}
     * @memberof TopEditedPagesByEditsItemsInner
     */
    'results'?: Array<TopEditedPagesByEditsItemsInnerResultsInner>;
}
