...
import { PageviewProjectItemsInner } from './pageview-project-items-inner';

/**
 * 
 * @export
 * @interface PageviewProject
 */
export interface PageviewProject {
    /**
     * 
     * @type {Array<PageviewProjectItemsInner>}
     * @memberof PageviewProject
     */
    'items'?: Array<PageviewProjectItemsInner>;
}
