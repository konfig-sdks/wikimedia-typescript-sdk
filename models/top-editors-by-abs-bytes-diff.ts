...
import { TopEditorsByAbsBytesDiffItemsInner } from './top-editors-by-abs-bytes-diff-items-inner';

/**
 * 
 * @export
 * @interface TopEditorsByAbsBytesDiff
 */
export interface TopEditorsByAbsBytesDiff {
    /**
     * 
     * @type {Array<TopEditorsByAbsBytesDiffItemsInner>}
     * @memberof TopEditorsByAbsBytesDiff
     */
    'items'?: Array<TopEditorsByAbsBytesDiffItemsInner>;
}
