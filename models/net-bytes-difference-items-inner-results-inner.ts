 ...
 * 
 * @export
 * @interface NetBytesDifferenceItemsInnerResultsInner
 */
export interface NetBytesDifferenceItemsInnerResultsInner {
    /**
     * 
     * @type {number}
     * @memberof NetBytesDifferenceItemsInnerResultsInner
     */
