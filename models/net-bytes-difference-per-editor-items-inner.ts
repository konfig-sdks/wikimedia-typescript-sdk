...
import { NetBytesDifferenceItemsInnerResultsInner } from './net-bytes-difference-items-inner-results-inner';

/**
 * 
 * @export
 * @interface NetBytesDifferencePerEditorItemsInner
 */
export interface NetBytesDifferencePerEditorItemsInner {
    /**
     * 
     * @type {string}
     * @memberof NetBytesDifferencePerEditorItemsInner
     */
    'granularity'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<NetBytesDifferenceItemsInnerResultsInner>}
     * @memberof NetBytesDifferencePerEditorItemsInner
     */
    'results'?: Array<NetBytesDifferenceItemsInnerResultsInner>;
    /**
     * 
     * @type {string}
     * @memberof NetBytesDifferencePerEditorItemsInner
