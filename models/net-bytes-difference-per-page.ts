...
import { NetBytesDifferencePerPageItemsInner } from './net-bytes-difference-per-page-items-inner';

/**
 * 
 * @export
 * @interface NetBytesDifferencePerPage
 */
export interface NetBytesDifferencePerPage {
    /**
     * 
     * @type {Array<NetBytesDifferencePerPageItemsInner>}
     * @memberof NetBytesDifferencePerPage
     */
    'items'?: Array<NetBytesDifferencePerPageItemsInner>;
}
