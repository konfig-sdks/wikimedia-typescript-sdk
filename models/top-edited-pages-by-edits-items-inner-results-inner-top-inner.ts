 ...
 * 
 * @export
 * @interface TopEditedPagesByEditsItemsInnerResultsInnerTopInner
 */
export interface TopEditedPagesByEditsItemsInnerResultsInnerTopInner {
    /**
     * 
     * @type {number}
     * @memberof TopEditedPagesByEditsItemsInnerResultsInnerTopInner
     */
    'edits'?: number;
    /**
     * 
